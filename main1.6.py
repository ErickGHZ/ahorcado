...
humano1 = shapes.Circle(175, 350, 35, segments=30, color=(139, 69, 19), batch=batch2)
humano2 = shapes.Line(175, 230, 175, 315, width=10, batch=batch2, color=(139, 69, 19))  # Cambia el color a café (RGB: 139, 69, 19)
humano3 = shapes.Line(175, 295, 220, 250, width=10, batch=batch2, color=(139, 69, 19))  # Cambia el color a café (RGB: 139, 69, 19)
humano4 = shapes.Line(130, 250, 175, 295, width=10, batch=batch2, color=(139, 69, 19))  # Cambia el color a café (RGB: 139, 69, 19)
humano5 = shapes.Line(175, 235, 220, 190, width=10, batch=batch2, color=(139, 69, 19))  # Cambia el color a café (RGB: 139, 69, 19)
humano6 = shapes.Line(130, 190, 175, 235, width=10, batch=batch2, color=(139, 69, 19))  # Cambia el color a café (RGB: 139, 69, 19)
